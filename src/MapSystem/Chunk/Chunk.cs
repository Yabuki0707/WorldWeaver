    ...
    public class Chunk : Object, IDisposable
    {
        ...
        ********************************/
        ...
        public bool InitializeValidChunkData(ChunkData setData)
        {
            ...
            if (setData.Width != OwnerManager.OwnerLayer.ChunkSize.X || setData.Height != OwnerManager.OwnerLayer.ChunkSize.Y)
            {
        ...
        ********************************/
        ...
        /// 向上传递 Tile 变化消息到事件总线
        /// </summary>
        internal void NotifyTileChanged(TileChangedEventArgs args)
        {
