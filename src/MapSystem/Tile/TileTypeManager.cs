...
namespace rasu.Map.Tile
{
    ...
    public static class TileTypeManager
    {
        ...
        ********************************/
        ...
        /// 资源目录常量，存储tiles所在的位置
        /// </summary>
        private static readonly string ResourceDir = ProjectSettings.GlobalizePath("res://assets/tiles");
        ...
        ********************************/
        ...
        public static void Initialize(bool printTileTypes = false)
        {
            ...
            {
                GD.PushError($"无法打开目录: {ResourceDir}");
                return;
            }
            ...
            string[] files = Directory.GetFiles(ResourceDir, "*.json");
