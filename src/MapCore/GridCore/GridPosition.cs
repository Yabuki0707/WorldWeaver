...
namespace WorldWeaver.MapCore.GridCore
{
    /// <summary>
    /// 地图网格位置，表示网格在世界中的坐标位置
    /// </summary>
    public readonly struct MapGridPosition : IPosition<MapGridPosition>, IEquatable<MapGridPosition>
    {
        /*******************************
              基本属性与基本方法
        ********************************/
        ...
        public bool Equals(MapGridPosition other)
        {
            return X == other.X && Y == other.Y;
        }
    }
